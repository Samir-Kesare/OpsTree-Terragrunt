...
inputs = {
        security_name = "qa-employee-sg"
        Security_description = "Security group for EmployeeAPI ASG in qa environment"
        ...
        autoscaling_group_name = "qa-employee-asg"
        subnet_ids = ["subnet-07f0a6d71640aa0cd"]
        tag_key = "Name"
        tag_value = "qa-employee-asg"
